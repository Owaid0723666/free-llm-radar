...
<!-- radar:start -->
最近一次：2026-09-21 05:41 UTC。18 个模型里 16 个能用。

| 服务商 | 模型 | 最近一次 | 用时 | 最近 7 次 |
| --- | --- | --- | ---: | ---: |
| OpenRouter | `nex-agi/nex-n2.5-mini:free` | 能用 | 0.3s | 1/1 |
| OpenRouter | `inclusionai/ling-3.0-flash-sante:free` | 能用 | 0.9s | 1/1 |
| OpenRouter | `nex-agi/nex-n2.5-pro:free` | 能用 | 0.9s | 1/1 |
| OpenRouter | `inclusionai/ling-3.0-flash-vl:free` | 能用 | 1.0s | 1/1 |
| OpenRouter | `inclusionai/ling-3.0-flash-fin:free` | 能用 | 1.1s | 1/1 |
| OpenRouter | `qwen/qwen3.8-27b:free` | 失败 (HTTP 429) | — | 0/1 |
| Google Gemini API | `gemini-3.1-flash-lite` | 能用 | 1.6s | 1/1 |
| Google Gemini API | `gemini-3-flash-preview` | 能用 | 1.8s | 1/1 |
| Mistral | `codestral-2508` | 能用 | 0.5s | 1/1 |
| Mistral | `ministral-3b-latest` | 能用 | 0.5s | 1/1 |
| Mistral | `ministral-8b-latest` | 能用 | 1.1s | 1/1 |
| Cloudflare Workers AI | `@cf/meta/llama-4-scout-17b-16e-instruct` | 能用 | 0.5s | 1/1 |
| Cloudflare Workers AI | `@cf/qwen/qwen2.5-coder-32b-instruct` | 能用 | 0.6s | 1/1 |
| Cloudflare Workers AI | `@cf/openai/gpt-oss-120b` | 能用 | 1.6s | 1/1 |
| NVIDIA NIM | `nvidia/nemotron-3-super-120b-a12b` | 能用 | 0.9s | 1/1 |
| NVIDIA NIM | `openai/gpt-oss-20b` | 能用 | 3.2s | 1/1 |
| NVIDIA NIM | `nvidia/nemotron-3.5-lightning-30b-a3b` | 能用 | 5.8s | 1/1 |
